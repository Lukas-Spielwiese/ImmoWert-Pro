...
exports.ermittleModernisierungsBonus = ermittleModernisierungsBonus;
exports.berechneSachwert = berechneSachwert;
 ...
 */
function ermittleModernisierungsBonus(modernisierung) {
 ...
 */
function berechneSachwert(input, bodenwert) {
    const prot = [];
    ...
    const indexF = (0, dataSources_1.indexFaktor)(basisIndex, ds.baupreisindex);
...
//# sourceMappingURL=sachwert.js.map