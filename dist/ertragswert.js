...
exports.barwertFaktor = barwertFaktor;
exports.berechneErtragswert = berechneErtragswert;
/**
 ...
 */
function berechneRohertrag(mietwerte) {
    if (!mietwerte || mietwerte.length === 0)
        return 0;
 ...
 */
function berechneBewirtschaftungskosten(bwk, rohertrag, prot) {
    if (!bwk)
        return 0;
    const anteile = [
 ...
 */
function berechneErtragswert(input, bodenwert) {
    const prot = [];
