...
// Bewirtschaftungskosten (Anlage 3)
...
// Haupteingaben einer Wertermittlung
...
// Modulresultat: Wert und Protokoll
export interface ModulResult {
  value: number;
  protocol: string[];
}

// Plausibilisierungsresultat
