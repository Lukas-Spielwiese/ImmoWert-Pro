 ...
 */
export function validateDataSources(d: any): DataSources {
  const data: DataSources = d as DataSources;
 ...
 */
export function indexFaktor(basisIndex: number, zielIndex: number): number {
 ...
 */
export function getIndexValue(ds: DataSources, key: 'baupreisindex' | 'verbraucherpreisindex'): number {
