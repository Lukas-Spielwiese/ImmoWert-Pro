...
import { EvaluationInput, VergleichsobjektInput } from './types';
 ...
 * vorgenommen werden.
 */
function normalizePreis(obj: VergleichsobjektInput): number {
 ...
 */
export function berechneVergleichswert(input: EvaluationInput): { value: number; protocol: string[] } {
  const prot: string[] = [];
